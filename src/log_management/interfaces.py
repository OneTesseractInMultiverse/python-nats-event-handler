...
class MicroserviceLogger(object):
    ...
    """
    A simple logger interface that provides abstraction of
    the actual implementation of the logger and enables injecting
    loggers to classes through dependency inversion principle.
    """
